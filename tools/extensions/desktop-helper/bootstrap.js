...
function injectMocks() {
  ...
  Services.obs.addObserver(function(document) {
    ...
    if (currentDomain.indexOf('system.gaiamobile.org') != -1) {
      ...
      scope = {
        w: window,
        addEventListener: function (type, fun, capture) this.w.addEventListener(type, fun, capture),
        removeEventListener: function (type, fun) this.w.removeEventListener(type, fun)
      };
      */
